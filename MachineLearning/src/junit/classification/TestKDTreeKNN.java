...
public class TestKDTreeKNN {
	...
	public void testDefaultKDtreeKNN() {
		...
		try {
			/* Load a data set */
			Dataset data = FileHandler.loadDataset(new File("src/data/iris.data"), 4, ",");
			/*
			 ...
			 * same one.
			 */
			Dataset dataForClassification = FileHandler.loadDataset(new File("src/data/iris.data"), 4, ",");
	...
	public void testSparseKNN() {
		...
		try {
			...
			Dataset data = FileHandler.loadSparseDataset(new File("src/data/smallsparse.tsv"), 0, "\t", ":");
			 ...
			 */
			System.out.println("Loading data...");
			Dataset dataForClassification = FileHandler.loadSparseDataset(new File("src/data/smallsparse.tsv"), 0,
					"\t", ":");
